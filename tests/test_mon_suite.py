...
def test_backward_wrt_x_matches_finite_difference():
    ...
    # Relative error tolerance; can be large near ReLU kinks despite positive b shift.
    # Implicit differentiation solves a monotone inclusion whose Clarke Jacobian
    # is set-valued at kinks, so finite-difference and autograd may disagree.
